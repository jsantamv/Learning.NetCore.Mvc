...
namespace Learning.FrontEnd.Controllers
{
    public class CursoesController : Controller
    {
        ...
        public CursoesController(EscuelaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Jornada,Nombre,Direccion,EscuelaId,Id")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Jornada,Nombre,Direccion,EscuelaId,Id")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
